...
describe('UNIX_START', () => {
  it('is correct', () => {
    assert.equal(UNIX_START, Date.UTC(1961, JAN, 1))
  })
})
...
describe('TaiConverter', () => {
  describe('OVERRUN', () => {
    ...
    describe('TAI raw data conversion unit tests based on magic numbers', () => {
      it('taiConverter.unixToAtomic (range mode)', () => {
        assert.deepEqual(taiConverter.unixToAtomic(63_072_010_000, { array: true }), [63_072_020_000])
        assert.deepEqual(taiConverter.unixToAtomic(78_796_811_000, { array: true }), [78_796_822_000])
        assert.deepEqual(taiConverter.unixToAtomic(94_694_412_000, { array: true }), [94_694_424_000])
        assert.deepEqual(taiConverter.unixToAtomic(126_230_413_000, { array: true }), [126_230_426_000])
        assert.deepEqual(taiConverter.unixToAtomic(157_766_414_000, { array: true }), [157_766_428_000])
        assert.deepEqual(taiConverter.unixToAtomic(189_302_415_000, { array: true }), [189_302_430_000])
        assert.deepEqual(taiConverter.unixToAtomic(220_924_816_000, { array: true }), [220_924_832_000])
        assert.deepEqual(taiConverter.unixToAtomic(252_460_817_000, { array: true }), [252_460_834_000])
        assert.deepEqual(taiConverter.unixToAtomic(283_996_818_000, { array: true }), [283_996_836_000])
        assert.deepEqual(taiConverter.unixToAtomic(315_532_819_000, { array: true }), [315_532_838_000])
        assert.deepEqual(taiConverter.unixToAtomic(362_793_620_000, { array: true }), [362_793_640_000])
        assert.deepEqual(taiConverter.unixToAtomic(394_329_621_000, { array: true }), [394_329_642_000])
        assert.deepEqual(taiConverter.unixToAtomic(425_865_622_000, { array: true }), [425_865_644_000])
        assert.deepEqual(taiConverter.unixToAtomic(489_024_023_000, { array: true }), [489_024_046_000])
        assert.deepEqual(taiConverter.unixToAtomic(567_993_624_000, { array: true }), [567_993_648_000])
        assert.deepEqual(taiConverter.unixToAtomic(631_152_025_000, { array: true }), [631_152_050_000])
        assert.deepEqual(taiConverter.unixToAtomic(662_688_026_000, { array: true }), [662_688_052_000])
        assert.deepEqual(taiConverter.unixToAtomic(709_948_827_000, { array: true }), [709_948_854_000])
        assert.deepEqual(taiConverter.unixToAtomic(741_484_828_000, { array: true }), [741_484_856_000])
        assert.deepEqual(taiConverter.unixToAtomic(773_020_829_000, { array: true }), [773_020_858_000])
        assert.deepEqual(taiConverter.unixToAtomic(820_454_430_000, { array: true }), [820_454_460_000])
        assert.deepEqual(taiConverter.unixToAtomic(867_715_231_000, { array: true }), [867_715_262_000])
        assert.deepEqual(taiConverter.unixToAtomic(915_148_832_000, { array: true }), [915_148_864_000])
        assert.deepEqual(taiConverter.unixToAtomic(1_136_073_633_000, { array: true }), [1_136_073_666_000])
        assert.deepEqual(taiConverter.unixToAtomic(1_230_768_034_000, { array: true }), [1_230_768_068_000])
        assert.deepEqual(taiConverter.unixToAtomic(1_341_100_835_000, { array: true }), [1_341_100_870_000])
        assert.deepEqual(taiConverter.unixToAtomic(1_435_708_836_000, { array: true }), [1_435_708_872_000])
        assert.deepEqual(taiConverter.unixToAtomic(1_483_228_837_000, { array: true }), [1_483_228_874_000])
      })

      it('taiConverter.unixToAtomic', () => {
        assert.deepEqual(taiConverter.unixToAtomic(63_072_010_000), 63_072_020_000)
        assert.deepEqual(taiConverter.unixToAtomic(78_796_811_000), 78_796_822_000)
        assert.deepEqual(taiConverter.unixToAtomic(94_694_412_000), 94_694_424_000)
        assert.deepEqual(taiConverter.unixToAtomic(126_230_413_000), 126_230_426_000)
        assert.deepEqual(taiConverter.unixToAtomic(157_766_414_000), 157_766_428_000)
        assert.deepEqual(taiConverter.unixToAtomic(189_302_415_000), 189_302_430_000)
        assert.deepEqual(taiConverter.unixToAtomic(220_924_816_000), 220_924_832_000)
        assert.deepEqual(taiConverter.unixToAtomic(252_460_817_000), 252_460_834_000)
        assert.deepEqual(taiConverter.unixToAtomic(283_996_818_000), 283_996_836_000)
        assert.deepEqual(taiConverter.unixToAtomic(315_532_819_000), 315_532_838_000)
        assert.deepEqual(taiConverter.unixToAtomic(362_793_620_000), 362_793_640_000)
        assert.deepEqual(taiConverter.unixToAtomic(394_329_621_000), 394_329_642_000)
        assert.deepEqual(taiConverter.unixToAtomic(425_865_622_000), 425_865_644_000)
        assert.deepEqual(taiConverter.unixToAtomic(489_024_023_000), 489_024_046_000)
        assert.deepEqual(taiConverter.unixToAtomic(567_993_624_000), 567_993_648_000)
        assert.deepEqual(taiConverter.unixToAtomic(631_152_025_000), 631_152_050_000)
        assert.deepEqual(taiConverter.unixToAtomic(662_688_026_000), 662_688_052_000)
        assert.deepEqual(taiConverter.unixToAtomic(709_948_827_000), 709_948_854_000)
        assert.deepEqual(taiConverter.unixToAtomic(741_484_828_000), 741_484_856_000)
        assert.deepEqual(taiConverter.unixToAtomic(773_020_829_000), 773_020_858_000)
        assert.deepEqual(taiConverter.unixToAtomic(820_454_430_000), 820_454_460_000)
        assert.deepEqual(taiConverter.unixToAtomic(867_715_231_000), 867_715_262_000)
        assert.deepEqual(taiConverter.unixToAtomic(915_148_832_000), 915_148_864_000)
        assert.deepEqual(taiConverter.unixToAtomic(1_136_073_633_000), 1_136_073_666_000)
        assert.deepEqual(taiConverter.unixToAtomic(1_230_768_034_000), 1_230_768_068_000)
        assert.deepEqual(taiConverter.unixToAtomic(1_341_100_835_000), 1_341_100_870_000)
        assert.deepEqual(taiConverter.unixToAtomic(1_435_708_836_000), 1_435_708_872_000)
        assert.deepEqual(taiConverter.unixToAtomic(1_483_228_837_000), 1_483_228_874_000)
      })

      it('taiConverter.atomicToUnix', () => {
        assert.equal(taiConverter.atomicToUnix(-283_996_800_000), NaN)
        assert.equal(taiConverter.atomicToUnix(63_072_010_000), 63_072_000_000)
        assert.equal(taiConverter.atomicToUnix(78_796_811_000), 78_796_800_000)
        assert.equal(taiConverter.atomicToUnix(94_694_412_000), 94_694_400_000)
        assert.equal(taiConverter.atomicToUnix(126_230_413_000), 126_230_400_000)
        assert.equal(taiConverter.atomicToUnix(157_766_414_000), 157_766_400_000)
        assert.equal(taiConverter.atomicToUnix(189_302_415_000), 189_302_400_000)
        assert.equal(taiConverter.atomicToUnix(220_924_816_000), 220_924_800_000)
        assert.equal(taiConverter.atomicToUnix(252_460_817_000), 252_460_800_000)
        assert.equal(taiConverter.atomicToUnix(283_996_818_000), 283_996_800_000)
        assert.equal(taiConverter.atomicToUnix(315_532_819_000), 315_532_800_000)
        assert.equal(taiConverter.atomicToUnix(362_793_620_000), 362_793_600_000)
        assert.equal(taiConverter.atomicToUnix(394_329_621_000), 394_329_600_000)
        assert.equal(taiConverter.atomicToUnix(425_865_622_000), 425_865_600_000)
        assert.equal(taiConverter.atomicToUnix(489_024_023_000), 489_024_000_000)
        assert.equal(taiConverter.atomicToUnix(567_993_624_000), 567_993_600_000)
        assert.equal(taiConverter.atomicToUnix(631_152_025_000), 631_152_000_000)
        assert.equal(taiConverter.atomicToUnix(662_688_026_000), 662_688_000_000)
        assert.equal(taiConverter.atomicToUnix(709_948_827_000), 709_948_800_000)
        assert.equal(taiConverter.atomicToUnix(741_484_828_000), 741_484_800_000)
        assert.equal(taiConverter.atomicToUnix(773_020_829_000), 773_020_800_000)
        assert.equal(taiConverter.atomicToUnix(820_454_430_000), 820_454_400_000)
        assert.equal(taiConverter.atomicToUnix(867_715_231_000), 867_715_200_000)
        assert.equal(taiConverter.atomicToUnix(915_148_832_000), 915_148_800_000)
        assert.equal(taiConverter.atomicToUnix(1_136_073_633_000), 1_136_073_600_000)
        assert.equal(taiConverter.atomicToUnix(1_230_768_034_000), 1_230_768_000_000)
        assert.equal(taiConverter.atomicToUnix(1_341_100_835_000), 1_341_100_800_000)
        assert.equal(taiConverter.atomicToUnix(1_435_708_836_000), 1_435_708_800_000)
        assert.equal(taiConverter.atomicToUnix(1_483_228_837_000), 1_483_228_800_000)
      })
    })
  })
  ...
  describe('STALL', () => {
    ...
    it('Demo', () => {
      ...
      assert.equal(taiConverter.atomicToUnix(915_148_832_000), 915_148_800_000)
      assert.equal(taiConverter.atomicToUnix(915_148_832_001), 915_148_800_001)
    })
    ...
    describe('TAI raw data conversion unit tests based on magic numbers', () => {
      it('taiConverter.unixToAtomic', () => {
        assert.equal(taiConverter.unixToAtomic(63_072_010_000), 63_072_020_000)
        assert.equal(taiConverter.unixToAtomic(78_796_811_000), 78_796_822_000)
        assert.equal(taiConverter.unixToAtomic(94_694_412_000), 94_694_424_000)
        assert.equal(taiConverter.unixToAtomic(126_230_413_000), 126_230_426_000)
        assert.equal(taiConverter.unixToAtomic(157_766_414_000), 157_766_428_000)
        assert.equal(taiConverter.unixToAtomic(189_302_415_000), 189_302_430_000)
        assert.equal(taiConverter.unixToAtomic(220_924_816_000), 220_924_832_000)
        assert.equal(taiConverter.unixToAtomic(252_460_817_000), 252_460_834_000)
        assert.equal(taiConverter.unixToAtomic(283_996_818_000), 283_996_836_000)
        assert.equal(taiConverter.unixToAtomic(315_532_819_000), 315_532_838_000)
        assert.equal(taiConverter.unixToAtomic(362_793_620_000), 362_793_640_000)
        assert.equal(taiConverter.unixToAtomic(394_329_621_000), 394_329_642_000)
        assert.equal(taiConverter.unixToAtomic(425_865_622_000), 425_865_644_000)
        assert.equal(taiConverter.unixToAtomic(489_024_023_000), 489_024_046_000)
        assert.equal(taiConverter.unixToAtomic(567_993_624_000), 567_993_648_000)
        assert.equal(taiConverter.unixToAtomic(631_152_025_000), 631_152_050_000)
        assert.equal(taiConverter.unixToAtomic(662_688_026_000), 662_688_052_000)
        assert.equal(taiConverter.unixToAtomic(709_948_827_000), 709_948_854_000)
        assert.equal(taiConverter.unixToAtomic(741_484_828_000), 741_484_856_000)
        assert.equal(taiConverter.unixToAtomic(773_020_829_000), 773_020_858_000)
        assert.equal(taiConverter.unixToAtomic(820_454_430_000), 820_454_460_000)
        assert.equal(taiConverter.unixToAtomic(867_715_231_000), 867_715_262_000)
        assert.equal(taiConverter.unixToAtomic(915_148_832_000), 915_148_864_000)
        assert.equal(taiConverter.unixToAtomic(1_136_073_633_000), 1_136_073_666_000)
        assert.equal(taiConverter.unixToAtomic(1_230_768_034_000), 1_230_768_068_000)
        assert.equal(taiConverter.unixToAtomic(1_341_100_835_000), 1_341_100_870_000)
        assert.equal(taiConverter.unixToAtomic(1_435_708_836_000), 1_435_708_872_000)
        assert.equal(taiConverter.unixToAtomic(1_483_228_837_000), 1_483_228_874_000)
      })
    ...
    describe('round trips', () => {
      describe('unixToAtomic and back', () => {
        ...
        numbers.forEach(number => {
          it(String(number), () => {
            assert.equal(taiConverter.atomicToUnix(taiConverter.unixToAtomic(number)), number)
          })
        })
      })
      ...
      describe('atomicToUnix and back', () => {
        ...
        numbers.forEach(number => {
          it(String(number), () => {
            assert.equal(taiConverter.unixToAtomic(taiConverter.atomicToUnix(number)), number)
          })
        })
      })
    })
