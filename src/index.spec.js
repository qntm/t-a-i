...
describe('Converter', () => {
  ...
  describe('OVERRUN_LAST', () => {
    ...
    it('boundaries', () => {
      ...
      // 1 November 1963: 0.1 TAI seconds inserted
      expect(converter.unixToAtomicPicos(Date.UTC(1963, OCT, 30, 23, 59, 59, 999)))
        .toBe(-194_745_597_404_844_400_013n)
      expect(converter.unixToAtomicPicos(Date.UTC(1963, NOV, 1, 0, 0, 0, 0)))
        .toBe(-194659197302721200000n)
      expect(converter.unixToAtomicPicos(Date.UTC(1963, NOV, 1, 0, 0, 0, 99)))
        .toBe(-194659197203721198713n)
      expect(converter.unixToAtomicPicos(Date.UTC(1963, NOV, 1, 0, 0, 0, 100)))
      ...
      expect(() => converter.unixToAtomicPicos(Date.UTC(1968, JAN, 31, 23, 59, 59, 901)))
        .toThrowError('No TAI equivalent: -60480000099')
      expect(() => converter.unixToAtomicPicos(Date.UTC(1968, JAN, 31, 23, 59, 59, 999)))
        .toThrowError('No TAI equivalent: -60480000001')
      ...
      expect(() => converter.unixToAtomicPicos(-265680000048))
        .toThrowError('No TAI equivalent: -265680000048')
      ...
      expect(() => converter.unixToAtomicPicos(-60480000098))
        .toThrowError('No TAI equivalent: -60480000098')
